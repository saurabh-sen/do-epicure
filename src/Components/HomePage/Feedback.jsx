  ...
  const submitHandle = (event) => {
    ...
    if (name && email && feedbackText) {
      set(ref(database, `feedback/${name}/`), {
        customer__feedback__name: name,
        customer__feedback__email: email,
        customer__feedback__message: feedbackText,
      })
        .then(() => {
          showAlert(
    ...
    <>
      ...
      <div className="Feedback">
        <div className="feedback_form">
          <form
            id="myForm"
            className="needs-validation needs-validation-1"
            noValidate
            onSubmit={submitHandle}
          >
            <div className="form-row">
              <div className="col mb-3">
                <label className="label" htmlFor="inputEmail4">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              <div className="col mb-3">
                <label className="label" htmlFor="inputName4">
                  Full Name
                </label>
                <input
                  type="text"
            ...
            <div className="form-row">
              <label className="label" htmlFor="exampleFormControlTextarea1">
                Elaborate your concern
              </label>
              <textarea
                placeholder="Write your Feedback/ Concern/ Reviews here....."
                className="form-control inputBtn"
            ...
            <button className="btn label submit_btn" type="submit">
              Submit Here!!!
            </button>
          </form>
        </div>
        <div className="feedback_item">
          <div className="feedback_line">l</div>
