...
function TermsAndServices() {
  return (
    <div className="termAndServices">
      ...
      <p>
        Welcome to <b>Epicure</b> {"(“Company”, “we”, “our”, “us”)"}!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>epicure.com</b> (together or individually
        “Service”) operated by <b>Epicure</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>saurabhsenwebsite@gmail.com</b> so we can try to find a solution.
      ...
      <p>
        We issue refunds for Contracts within <b>10 days</b> of the original
      ...
      <p>
        Content found on or through this Service are the property of Epicure or
      ...
      <p>
        ...
        Epicure and its licensors. Service is protected by copyright, trademark,
      ...
      <p>
        ...
        to saurabhsenwebsite@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at saurabhsenwebsite@gmail.com or via
      ...
      <p>
        ...
        are not owned or controlled by Epicure.
      </p>
      <p>
        Epicure has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>saurabhsenwebsite@gmail.com</b>.
      </p>
      <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
        These <Link to="/termsandservices">Terms of Service</Link> were created
        for <b>epicure.com</b> on 2021-12-15.
      </p>
    </div>
  );
}
